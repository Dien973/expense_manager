...
if(isset($_POST['submit'])){
   ...
   $select_users = mysqli_query($conn, "SELECT * FROM `users` WHERE uemail = '$email' AND upwd = '$pass'") or die('Thất bại');
...
<section class="form-container">
   ...
   <form action="" method="post">
      ...
      <div class="input-boxes">
         ...
         <div class="forgot-password" class="text"><a href="forgot_pwd.php">Quên mật khẩu?</a></div>
