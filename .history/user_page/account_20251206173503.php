...
<body>
    <div class="profile">
        <form action="" method="post" enctype="multipart/form-data">
            ...
            <button type="submit" name="delete_account" id="deleteBtn" class="delete">Xóa tài khoản</button>

        </form>

    </div>

    <div id="deletePopup" class="message-overlay" style="display:none;">
        <div class="message-box">
            <i id="closeDelete" class="fa-solid fa-xmark"></i>
            <span>Bạn có chắc chắn muốn đăng xuất?</span>

            <div style="margin-top: 20px;">
                <button id="confirmDelete" class="btn" style="margin-right:10px;">OK</button>
