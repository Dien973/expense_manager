...
if(isset($_POST['submit'])){
   ...
   $select_users = mysqli_query($conn, "SELECT * FROM `users` WHERE email = '$email' AND upassword = '$pass'") or die('Thất bại');
...
<section class="form-container">
   ...
   <form action="" method="post">
      ...
      <div class="input-boxes">
         ...
         <p>Bạn chưa có tài khoản? <a href="user_page/signup.php">Đăng kí ngay</a></p>
      </div>
   </form>
</section>
